...
public class Decoder
{
	class LenDecoder
	{
		...
		public void Init()
		{
			RangeCoder.Decoder.InitBitModels(m_Choice);
		...
		public int Decode(RangeCoder.Decoder rangeDecoder, int posState) throws IOException
		{
	...
	class LiteralDecoder
	{
		class Decoder2
		{
			...
			public void Init()
			{
				RangeCoder.Decoder.InitBitModels(m_Decoders);
			}
			
			public byte DecodeNormal(RangeCoder.Decoder rangeDecoder) throws IOException
			{
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte(RangeCoder.Decoder rangeDecoder, byte matchByte) throws IOException
			{
				int symbol = 1;
				do
				{
	...
	void Init() throws IOException
	{
		...
		RangeCoder.Decoder.InitBitModels(m_IsMatchDecoders);
		RangeCoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
		RangeCoder.Decoder.InitBitModels(m_IsRepDecoders);
		RangeCoder.Decoder.InitBitModels(m_IsRepG0Decoders);
		RangeCoder.Decoder.InitBitModels(m_IsRepG1Decoders);
		RangeCoder.Decoder.InitBitModels(m_IsRepG2Decoders);
		RangeCoder.Decoder.InitBitModels(m_PosDecoders);
